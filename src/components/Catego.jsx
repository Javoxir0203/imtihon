		...
		<>
			<div className='w-[30%] mb-24'>
				...
				<ul className='grid grid-cols-4 gap-2'>
					...
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>S/M</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>M</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>M/L</li>
					...
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>6</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>7</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>8</li>
				</ul>
				<div className='flex justify-between mt-14'>
