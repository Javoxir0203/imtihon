		...
		<>
			<div className='w-[30%] mb-24'>
				...
				<ul className='grid grid-cols-4 gap-2'>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>XXS</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>XS</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>S</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>M</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>L</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>XL</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>23</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>24</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>25</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>26</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>27</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>28</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>29</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>30</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>31</li>
					<li className='border rounded text-center py-2 hover:bg-[#ED165F] '>32</li>
				</ul>
				<div className='flex justify-between mt-14'>
